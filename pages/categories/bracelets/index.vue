...
.category
  ...
  <script>
    export default{
      ...
      data() {
        return {
          desc: 'Хотите, чтобы каждый ваш образ был запоминающимся? Браслет плетеный — отличный вариант для тех, кто следует своему стилю и стремится к оригинальности во всем.'
        }
      },
      async fetch ({ store }) {
