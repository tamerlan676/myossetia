...
import CaseCollections from '~/components/CaseCollections.vue';
    ...
    data() {
      return {
        desc: 'Рады представить совместную коллекцию кейсов на ваши телефоны с талантливым художником из Москвы Дарьей Орловой. Она работает над иллюстрациями для журналов и медиа- изданий, а также собственными проектами, один из которых воплотился в нашей новой коллекции. Вдохновившись эстетикой быта и традициями Осетии, она создала серию иллюстраций, посвящённую значимым явлениям нашей культуры.',
      }
    },
